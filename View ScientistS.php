					...
					{	
							...
							while($row = $result->fetch_array(MYSQLI_ASSOC))
							{
								...
								echo<<<abc
									...
									<td>
									<div class="info">Full Name: $b $c<br/>Email-ID: $g<br/>Date of Joining: $j<br/>Mission Working: $k(Currently working Mission)<br/>Designation: $l</div>
									</td>
									</tr>		 
									</table> 
abc;
	...
	{   
		...
		<td><div class="info">Full Name: $b $c<br/>Email-ID: $g<br/>Date of Joining: $j<br/>Mission Working: $k(Currently working Mission)<br/>Designation: $l</div>
		</td>
</tr>
